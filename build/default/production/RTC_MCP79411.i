...
I2C_Write(0xDE);
I2C_Write(0x00);
I2C_Write(decimalToBCD(second | 0x80));
I2C_Write(decimalToBCD(minute));
I2C_Write(decimalToBCD(hour & 0x1F));
I2C_stop();
}
...
I2C_Write(0xDE);
I2C_Write(0x03);
I2C_Write(decimalToBCD(weekDay | 0x28));
...
# 59
void MCP794x_setAlarm(uint8_t alarmMask, uint8_t time) {
MCP794x_writeRtcc(0x0D, 0x00);
MCP794x_writeRtcc(0x0D, alarmMask);

switch (alarmMask) {
case second:MCP794x_writeRtcc(0x0A, decimalToBCD(time));
break;
case minute:MCP794x_writeRtcc(0x0B, decimalToBCD(time));
break;
case hour:MCP794x_writeRtcc(0x0C, (decimalToBCD(time)) & 0xBF);
break;
case dayWk:MCP794x_writeRtcc(0x0D, (decimalToBCD(time)) >> 6);
break;
case date:MCP794x_writeRtcc(0x0E, decimalToBCD(time));
break;
case SMHDD:
MCP794x_writeRtcc(0x0A, decimalToBCD(time));
MCP794x_writeRtcc(0x0B, decimalToBCD(time));
MCP794x_writeRtcc(0x0C, (decimalToBCD(time)) & 0xBF);
MCP794x_writeRtcc(0x0D, (decimalToBCD(time)) >> 6);
MCP794x_writeRtcc(0x0E, decimalToBCD(time));
MCP794x_writeRtcc(0x0F, decimalToBCD(time));
break;
}
MCP794x_writeRtcc(0x07, 0x10);
}
...
uint8_t MCP794x_INTF_CLR(void) {
MCP794x_writeRtcc(0x0D, MCP7941x_read(0x0D)& 0xF5);
_delay((unsigned long)((10)*(16000000/4000.0)));
}
