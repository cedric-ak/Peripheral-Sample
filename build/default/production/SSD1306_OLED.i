...
SSD1306_writeCMD(0xAE, 0xAE);

SSD1306_writeCMD(0xA8, 63);

# 26
SSD1306_writeCMD(0xD3, 0x0);
SSD1306_writeCMD(0x8D,0x8D);
SSD1306_writeCMD(0x20, 0x00);
SSD1306_writeCMD(0x40, 0x40);
SSD1306_writeCMD(0xA1, 0xA1);
SSD1306_writeCMD(0xC8, 0xC8);


SSD1306_writeCMD(0xDA, 0x12);
SSD1306_writeCMD(0x81, 0x7F);

# 46
SSD1306_writeCMD(0xD9, 0xD9);
SSD1306_writeCMD(0xDB, 0x40);
SSD1306_writeCMD(0xA4, 0xA4);
SSD1306_writeCMD(0xA6, 0xA6);
SSD1306_writeCMD(0xD5, 0x80);
SSD1306_writeCMD(0x8D, 0x14);
SSD1306_writeCMD(0x2E, 0x2E);
SSD1306_writeCMD(0xAF, 0xAF);
}
...
dataByte == 0xFF ? I2C_stop() : I2C_Write(dataByte);
I2C_stop();
}
...
# 292
void SSD1306_startscrolldiagright(uint8_t start, uint8_t stop) {
SSD1306_writeCMD(0xA3, 0x00);
SSD1306_writeCMD(64, 64);
SSD1306_writeCMD(0x29, 0x00);
SSD1306_writeData(start);
SSD1306_writeData(0x00);
SSD1306_writeData(stop);
...
if ((c < ' ') || (c > '~'))
c = '?';
SSD1306_writeCMD(0x21,0x21);
SSD1306_writeData(6 * (x_pos - 1));
SSD1306_writeData(6 * (x_pos - 1) + 4);

SSD1306_writeCMD(0x22,0x22);
SSD1306_writeData(y_pos - 1);
SSD1306_writeData(y_pos - 1);
