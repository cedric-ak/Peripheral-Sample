...
# 11 "MCP23008_IO_expender.c"
void MCP23008_pinMode(int port, int mode) {
int dataRead;
dataRead = MCP23008_reagReg(0x00);
...
void MCP23008_Write(int port, int data) {
int dataRead;
dataRead = MCP23008_reagReg(0x0A);
...
void MCP23008_pullUp(int port) {
int dataRead;
dataRead = MCP23008_reagReg(0x06);
...
dataRead = MCP23008_reagReg(0x02);
...
dataRead = MCP23008_reagReg(0x03);
I2C_start();
I2C_Write(0x40);
I2C_Write(0x03);
if (INTedge == 0x00) {
...
dataRead = MCP23008_reagReg(0x04);
I2C_start();
I2C_Write(0x40);
I2C_Write(0x04);
I2C_Write(dataRead |(0x01 << port));
